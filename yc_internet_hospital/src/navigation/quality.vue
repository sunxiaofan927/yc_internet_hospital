    ...
    <el-dialog title="处方详情" :visible.sync="dialogFormVisible">
      ...
      <el-collapse v-model="activeNames" @change="handleChange" v-if="list_1">
        ...
        <el-collapse-item title="签章" name="7">
          ...
          <div class="signContainer">
            ...
            <img
              ...
              :src="
                ...
                details.prescriptionManageBean.h_esign
              "
              alt=""
              srcset=""
              title="公司签章"
          ...
          <div class="signContainer">
            ...
            <div class="signRight">
              <!-- <img
                ...
                :src="
                  'data:image/jpg;base64,' +
                  details.prescriptionManageBean.d_esign
                "
                alt=""
                srcset=""
                title="医师签章"
              ...
              <img
                class="imgup_buttom"
                @click="imgup(details.prescriptionManageBean.sh_doc_esign)"
                :src="
                  'data:image/jpg;base64,' +
                  details.prescriptionManageBean.sh_doc_esign
                "
                alt=""
                srcset=""
                title="医师签章"
          ...
          <div class="signContainer" v-show="isImage">
            ...
            <div class="signRight">
              <!-- <img
                ...
                :src="
                  'data:image/jpg;base64,' +
                  details.prescriptionManageBean.p_esign
                "
                alt=""
                srcset=""
                title="医师签章"
              ...
              <img
                class="imgup_buttom"
                @click="imgup(details.prescriptionManageBean.sh_p_esign)"
                :src="
                  'data:image/jpg;base64,' +
                  details.prescriptionManageBean.sh_p_esign
                "
                alt=""
                srcset=""
                title="医师签章"
          ...
          <div class="signContainer" v-show="R_Image">
            <span>复核药师:</span>
            <div class="signRight">
              <!-- <img
                class="imgup_buttom"
                @click="imgup(details.prescriptionManageBean.r_esign_sealData)"
                :src="
                  'data:image/jpg;base64,' +
                  details.prescriptionManageBean.r_esign_sealData
                "
                alt=""
                srcset=""
                title="医师签章"
              ...
              <img
                class="imgup_buttom"
                @click="
                  imgup(details.prescriptionManageBean.r_esign_sxsealData)
                "
                :src="
                  'data:image/jpg;base64,' +
                  details.prescriptionManageBean.r_esign_sxsealData
                "
                alt=""
                srcset=""
                title="医师签章"
...
export default {
  data() {
    return {
      ...
      cols1: [
        ...
        { prop: "p_r_nickname", label: "审核医师", width: "" },
  ...
  computed: {
    ...
    Type() {
      return this.$store.state.login.user_type;
    },
  },
  methods: {
    clickPrint() {
